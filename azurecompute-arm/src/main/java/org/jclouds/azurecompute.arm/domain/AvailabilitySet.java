...
public abstract class AvailabilitySet {
   ...
   public static AvailabilitySet create(final String id, final String name, final String type, final String location,
                                        @Nullable final Map<String, String> tags, AvailabilitySetProperties properties) {
      return new AutoValue_AvailabilitySet(id, name, type, location, tags == null ? ImmutableMap.<String, String>builder().build() : ImmutableMap.copyOf(tags), properties);
   }
}
