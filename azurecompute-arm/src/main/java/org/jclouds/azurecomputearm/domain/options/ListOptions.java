 ...
 */
package org.jclouds.azurecomputearm.domain.options;
...
public class ListOptions extends BaseHttpRequestOptions {
    ...
    /**
     * Configures the number of entries to return.
     */
    public ListOptions top(int top) {
        queryParameters.put(TOP_PARAM, String.valueOf(top));
        return this;
    }
    ...
    public static final class Builder {
        ...
        /**
         * @see {@link ListOptions#top(int)}
         */
        public static ListOptions top(int top) {
            return new ListOptions().top(top);
        }
