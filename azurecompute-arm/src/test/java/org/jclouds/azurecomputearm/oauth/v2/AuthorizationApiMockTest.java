...
public class AuthorizationApiMockTest {
   private static final String SCOPE = "http://management.azure.com/";
   ...
   private AzureAuthorizationApi api(URL url) throws IOException {
      ...
      overrides.setProperty(CREDENTIAL_TYPE, CLIENT_CREDENTIALS_SECRET.toString());
      overrides.setProperty(AUDIENCE, "https://management.azure.com/");
