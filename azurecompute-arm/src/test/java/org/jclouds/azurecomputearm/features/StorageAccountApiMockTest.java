...
public class StorageAccountApiMockTest extends BaseAzureComputeApiMockTest {
   ...
   public void testList() throws Exception {
      ...
      try {
         ...
         assertSentJSON(server, "GET", "/subscriptions/" + subsriptionId +
   ...
   public void testCreate() throws Exception {
      ...
      try {
         ...
         assertSentJSON(server, "PUT", "/subscriptions/" + subsriptionId +
   ...
   public void testIsAvailable() throws Exception {
      ...
      try {
         ...
         assertSentJSON(server, "POST", "/subscriptions/" + subsriptionId +
   ...
   public void testGet() throws Exception {
      ...
      try {
         ...
         assertEquals(api.get("serviceName"), expected().get(0));

         assertSentJSON(server, "GET", "/subscriptions/" + subsriptionId + "/resourcegroups/" + resourceGroup +
   ...
   public void testGetKeys() throws Exception {
      ...
      try {
         ...
         assertSentJSON(server, "POST", "/subscriptions/" + subsriptionId + "/resourcegroups/" + resourceGroup +
   ...
   public void testUpdate() throws Exception {
      ...
      try {
         ...
         assertSentJSON(server, "PATCH", "/subscriptions/" + subsriptionId + "/resourcegroups/" + resourceGroup +
         "/providers/Microsoft.Storage/storageAccounts/serviceName?api-version=2015-06-15");
      } finally {
         server.shutdown();
      }
   ...
   public void testDelete() throws Exception {
      ...
      try {
         ...
         assertSentJSON(server, "DELETE", "/subscriptions/" + subsriptionId + "/resourcegroups/" + resourceGroup +
                 "/providers/Microsoft.Storage/storageAccounts/serviceName?api-version=2015-06-15");
      } finally {
         server.shutdown();
      }
