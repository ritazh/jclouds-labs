...
import org.jclouds.azurecomputearm.domain.DataDisk;
import org.jclouds.azurecomputearm.domain.DiagnosticsProfile;
import org.jclouds.azurecomputearm.domain.HardwareProfile;
import org.jclouds.azurecomputearm.domain.ImageReference;
import org.jclouds.azurecomputearm.domain.NetworkInterfaceCard;
import org.jclouds.azurecomputearm.domain.NetworkProfile;
import org.jclouds.azurecomputearm.domain.OSDisk;
import org.jclouds.azurecomputearm.domain.OSProfile;
import org.jclouds.azurecomputearm.domain.StorageProfile;
import org.jclouds.azurecomputearm.domain.StorageService;
import org.jclouds.azurecomputearm.domain.VHD;
...
public class VirtualMachineApiLiveTest extends BaseAzureComputeApiLiveTest {
   ...
   public void testCreate() {
      ...
      String id = "/subscriptions/" + getSubscriptionId() + "/resourceGroups/" + getResourceGroupName() +
   ...
   private VirtualMachineApi api() {
      return api.getVirtualMachineApi(getSubscriptionId(), getResourceGroupName());
   }
