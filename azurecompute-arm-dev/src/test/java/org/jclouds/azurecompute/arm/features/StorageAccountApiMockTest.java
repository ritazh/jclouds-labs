...
//
//      List<StorageService> list = storageAPI.listAll();
//      assertEquals(list, expected());
//
//      assertSent(server, "GET", "/subscriptions/" + subsriptionId +
...
//      final StorageAccountApi storageAPI = api.getStorageAccountApi(subsriptionId, resourceGroup);
//
//      assertTrue(storageAPI.listAll().isEmpty());
//
//      assertSent(server, "GET", "/subscriptions/" + subsriptionId +
//              "/providers/Microsoft.Storage/storageAccounts?api-version=2015-06-15");
//   }
   ...
   private CreateStorageServiceParams getCreateResponse() {
      CreateStorageServiceParams params = CreateStorageServiceParams.create("westus",
      ImmutableMap.of("property_name", "property_value"), ImmutableMap.of("accountType", StorageService.AccountType.Premium_LRS.toString()));
      return params;
   }
